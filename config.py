...
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5650717789]
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Source-Ze/V1")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/UI_OS")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/UI_XB")
